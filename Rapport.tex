...
\paragraph{}
A ce jour nous avons une application qui gère un nombre non limité d'appareils inter-connectés simultanément. Nous pouvons nous connecter à un réseau existant à n'importe quel moment et être connu de tous.
\paragraph{}
...
\paragraph{}
La principale difficulté que nous avons eu est la découverte du fonctionnement d'Android, c'est à dire comprendre l'architecture et l'articulation de toutes les parties d'une application. C'est en partie du à cela que nous n'avons pas pu mettre mettre en place l'algorithme.
