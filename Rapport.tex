...
\chapter{Recherche des technologies de communication}
  ...
  \section{Wifi Direct}
    ...
    \subsection{Fonctionnement}
     \paragraph{}
    L'activation du Wifi Direct sur les appareils ne nécessite d'activer qu'une option \todo{quelle option ?} dans les paramètres \todo{activation à faire à la main par l'utilisateur ou possible depuis le code comme pour le bluetooth ?}. Une fois ceci fait, l'envoi des fichiers est possible. En revanche le Wifi Direct n'est utilisable que sur les dispositifs installés sous Android 4.0 minimum.
    \subsection{Avantages}
     \paragraph{}
