...
\chapter{Recherche des technologies de communication}
  ...
  \section{Bluetooth}
  \todo{La première fois que tu utilise le mot Bluetooth met un petit * à droite du mot pour dire que c'est défini dans le glossaire}
...
\begin{figure}[h]
    ...
    \caption{Fonction d'appel de règles de l'API}
\end{figure}
